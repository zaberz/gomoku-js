...
const {zip, Random} = require('./utils');
...
class MCTS {
    ...
    constructor(policy_value_fn, c_puct = 5, n_playout = 10000) {
        // 初始化蒙特卡洛树搜索
        // 参数:
        ...
        // this._policy = policy_value_fn_2;
        this._c_puct = c_puct;
    ...
    _playout(game) {
        ...
        // 检查是否游戏结束
        let [game_over, winner] = game.game_end();
...
module.exports = class MTCSPlayer {
